...
import { getArmorByName, getWeaponByName } from './equipment'
...
export interface MagicItem {
  ...
  /** True if attunement is required (optionally by a specific class/type). */
  attunement: boolean
  /** E.g. 'a cleric, druid, or paladin' if attunement is class-restricted. */
  attunementNote?: string
  /** Weight in pounds. Use 0 for negligible-weight items or variable generic placeholders. */
  weight: number
...
export const magicItems: readonly MagicItem[] = [
  ...
  },
  {
    ...
    attunement: false,
    weight: 1,
    description: "This hollow metal tube measures about 1 foot long and weighs 1 pound. As a Magic action, you can strike the chime to cast _Knock_. The spell's customary knocking sound is replaced by the clear, ringing tone of the chime, which is audible out to 300 feet.\n\nThe chime can be used 10 times. After the tenth time, it cracks and becomes useless.",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "While touching this crystal orb, you can cast _Scrying_ (save DC 17) with it.",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "While touching this crystal orb, you can cast _Scrying_ (save DC 17) with it. In addition, you have Truesight with a range of 120 feet centered on the spell's sensor.",
  },
  {
    id: "cube-of-force",
    name: "Cube of Force",
  ...
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "Weapon (Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Rare (Requires Attunement)",
  },
  {
  ...
  },
  {
    ...
    rarity: "Very Rare",
    attunement: true,
  attunementNote: "a Dwarf or a Creature Attuned to a Belt of Dwarvenkind",
    weight: 2,
    description: "Weapon (Warhammer), Very Rare (Requires Attunement by a Dwarf or a Creature Attuned to a Belt of Dwarvenkind)",
  },
  {
    id: "efficient-quiver",
  ...
  },
  {
    ...
    attunement: true,
    weight: 0,
    description: "Weapon (Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Very Rare (Requires Attunement)",
  },
  {
  ...
  },
  {
    ...
    rarity: "Legendary",
    attunement: true,
  attunementNote: "a Paladin",
    weight: 0,
    description: "Weapon (Any Simple or Martial), Legendary (Requires Attunement by a Paladin)",
  },
  {
    id: "horn-of-blasting",
  ...
  },
  {
    ...
    attunement: false,
    weight: 2,
    description: "While lit, this hooded lantern burns for 6 hours on 1 pint of oil, shedding Bright Light in a 30-foot radius and Dim Light for an additional 30 feet. Invisible creatures and objects are visible as long as they are in the lantern's Bright Light. You can take a Utilize\naction to lower the hood, reducing the lantern's light to Dim Light in a 5-foot radius.",
  },
  {
    id: "luck-blade",
    name: "Luck Blade",
    ...
    attunement: true,
    weight: 0,
    description: "Weapon (Glaive, Greatsword, Longsword, Rapier, Scimitar, Sickle, or Shortsword), Legendary (Requires Attunement)",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 5,
    description: "This tome contains information and incantations necessary to make a particular type of golem. The GM chooses the type or determines it randomly by rolling on the accompanying table. To decipher and use the manual, you must be a spellcaster with at least two level 5 spell slots. A creature that can't use a _Manual of Golems_ and attempts to read it takes 6d6 Psychic damage.\n\nTo create a golem, you must spend the time shown on the table, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay the specified cost to purchase supplies.\n\nOnce you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. See \"Monsters\" for the golem's stat block. The golem is under your control, and it understands and obeys your commands.\n\n<table>\n  <thead>\n    <tr>\n      <th>1d20</th>\n      <th>Golem</th>\n      <th>Time</th>\n      <th>Cost</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td>1–5</td>\n      <td>Clay Golem</td>\n      <td>30 days</td>\n      <td>65,000 GP</td>\n    </tr>\n    <tr>\n      <td>6–17</td>\n      <td>Flesh Golem</td>\n      <td>60 days</td>\n      <td>50,000 GP</td>\n    </tr>\n    <tr>\n      <td>18</td>\n      <td>Iron Golem</td>\n      <td>120 days</td>\n      <td>100,000 GP</td>\n    </tr>\n    <tr>\n      <td>19–20</td>\n      <td>Stone Golem</td>\n      <td>90 days</td>\n      <td>80,000 GP</td>\n    </tr>\n  </tbody>\n</table>",
  },
  {
  ...
  },
  {
    ...
    rarity: "Uncommon",
    attunement: true,
  attunementNote: "a Spellcaster",
    weight: 0,
    description: "Wondrous Item, Uncommon (Requires Attunement by a Spellcaster)",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, you gain the effect of the _Clairvoyance_ spell (no Concentration required).\n\nAn eyeball bobs in this potion's yellowish liquid but vanishes when the potion is opened.",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, you gain the effect of the _Gaseous Form_ spell for 1 hour (no Concentration required) or until you end the effect as a Bonus Action.\n\nThis potion's container seems to hold fog that moves and pours like water.",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, you gain 10 Temporary Hit Points that last for 1 hour. For the same duration, you are under the effect of the _Bless_ spell (no Concentration required).\n\nThis potion's blue liquid bubbles and steams as if boiling.",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, your physical age is reduced by 1d6 + 6 years, to a minimum of 13 years. Each time you subsequently drink a _Potion of Longevity_, there is 10 percent cumulative chance that you instead age by 1d6 + 6 years.\n\nSuspended in this amber liquid is a tiny heart that, against all reason, is still beating. These ingredients vanish when the potion is opened.",
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, you gain the effect of the _Detect Thoughts_ spell (save DC 13) for 10 minutes (no Concentration required).\n\nThis potion's dense, purple liquid has an ovoid cloud of pink floating in it.",
  },
  {
    id: "potion-of-poison",
    ...
    attunement: false,
    weight: 0.5,
    description: "This concoction looks, smells, and tastes like a _Potion of Healing_ or another beneficial potion. However, it is actually poison masked by illusion magic. _Identify_ reveals its true nature.\n\nIf you drink this potion, you take 4d6 Poison damage and must succeed on a DC 13 Constitution saving throw or have the Poisoned condition for 1 hour.",
  },
  {
  ...
  },
  {
    ...
    attunement: false,
    weight: 0.5,
    description: "When you drink this potion, you gain the effect of the _Haste_ spell for 1 minute (no Concentration required) without suffering the wave of lethargy that typically occurs when the effect ends.\n\nThis potion's yellow fluid is streaked with black and swirls on its own.",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 2,
    description: "The rod has 5 charges. While you hold it, you can cast one of the following spells from it: _Heal_ (expends 1 charge) or _Resurrection_ (expends 5 charges).\n\nThe rod regains 1 expended charge daily at dawn. If you expend the last charge, roll 1d20. On a 1, the rod disappears in a harmless burst of radiance.",
  },
  {
    id: "rod-of-rulership",
  ...
  },
  {
    ...
    attunement: false,
    weight: 1,
    description: "_Sending Stones_ come in pairs, with each stone carved to match the other so the pairing is easily recognized. While you touch one stone, you can cast _Sending_ from it. The target is the bearer of the other stone. If no creature bears the other stone, you know that fact as soon as you use the stone, and you don't cast the spell.\n\nOnce _Sending_ is cast using either stone, the stones can't be used again until the next dawn. If one of the stones in a pair is destroyed, the other one becomes nonmagical.",
  },
  {
    id: "sentinel-shield",
  ...
  },
  {
    ...
    rarity: "Rare",
    attunement: true,
  attunementNote: "a Bard, Cleric, Druid, Sorcerer, Warlock, or Wizard",
    weight: 4,
    description: "Staff, Rare (Requires Attunement by a Bard, Cleric, Druid, Sorcerer, Warlock, or Wizard)",
  },
  {
    id: "staff-of-fire",
    name: "Staff of Fire",
    ...
    rarity: "Very Rare",
    attunement: true,
  attunementNote: "a Druid, Sorcerer, Warlock, or Wizard",
    weight: 4,
    description: "Staff, Very Rare (Requires Attunement by a Druid, Sorcerer, Warlock, or Wizard)",
  },
  {
    id: "staff-of-frost",
    name: "Staff of Frost",
  ...
  },
  {
    ...
    rarity: "Rare",
    attunement: true,
  attunementNote: "a Bard, Cleric, or Druid",
    weight: 4,
  ...
  attunementNote: "a Sorcerer, Warlock, or Wizard",
    weight: 4,
    description: "Staff, Very Rare (Requires Attunement by a Sorcerer, Warlock, or Wizard)",
  },
  {
  ...
  attunementNote: "a Sorcerer, Warlock, or Wizard",
    weight: 4,
    description: "Staff, Legendary (Requires Attunement by a Sorcerer, Warlock, or Wizard)",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "Weapon (Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword), Rare (Requires Attunement)",
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "Weapon (Glaive, Greatsword, Longsword, or Scimitar), Very Rare (Requires Attunement)",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 4,
    description: "This magic weapon has 3 charges, and it regains 1d3 expended charges daily at dawn. While you carry it, you can expend 1 charge to cast _Dominate Beast_ (save DC 15) from it on a Beast that has a Swim Speed.",
  },
  {
  ...
  },
  {
    ...
    attunement: true,
    weight: 3,
    description: "Weapon (Glaive, Greatsword, Longsword, or Scimitar), Legendary (Requires Attunement)",
  },
  {
    id: "wand-of-binding",
  ...
  },
  {
    ...
    attunement: false,
    weight: 1,
    description: "This wand has 3 charges. While holding it, you can expend 1 charge to cast _Detect Magic_ from it. The wand regains 1d3 expended charges daily at dawn.",
  },
  {
    ...
    attunement: false,
    weight: 1,
    description: "This wand has 7 charges. While holding it, you can expend no more than 3 charges to cast _Magic Missile_ from it. For 1 charge, you cast the level 1 version of the spell. You can increase the spell's level by 1 for each additional charge you expend.\n\n_Regaining Charges._ The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand's last charge, roll 1d20. On a 1, the wand crumbles into ashes and is destroyed.",
  },
  {
  ...
  attunementNote: "a Spellcaster",
    weight: 1,
    description: "Wand, Uncommon (+1), Rare (+2), or Very Rare (+3) (Requires Attunement by a Spellcaster)",
  },
  {
    id: "wand-of-web",
    name: "Wand of Web",
  ...
  },
  {
    ...
    attunement: false,
    weight: 0,
    description: "While holding this fan, you can cast _Gust of Wind_ (save DC 13) from it. Each subsequent time the fan is used before the next dawn, it has a cumulative 20 percent chance of not working; if the fan fails to work, it tears into useless, nonmagical tatters.",
  },
  {
    id: "winged-boots",
    name: "Winged Boots",
...
// ─── Specific +1/+2/+3 Weapons (SRD 5.2.1 standard magic items) ─────────────
// These are concrete versions of "Weapon, +1, +2, or +3" for common weapons.

const PLUS_WEAPONS = [
  'Battleaxe', 'Dagger', 'Flail', 'Glaive', 'Greataxe', 'Greatsword', 'Halberd',
  'Hand Crossbow', 'Handaxe', 'Heavy Crossbow', 'Lance', 'Light Crossbow',
  'Longsword', 'Maul', 'Morningstar', 'Pike', 'Quarterstaff', 'Rapier',
  'Scimitar', 'Shortsword', 'Spear', 'Trident', 'Warhammer', 'War Pick', 'Whip',
  'Longbow', 'Shortbow',
]

const PLUS_ARMOR: [string, string][] = [
  ['Leather Armor', 'Armor (Leather Armor)'],
  ['Studded Leather Armor', 'Armor (Studded Leather Armor)'],
  ['Hide Armor', 'Armor (Hide Armor)'],
  ['Chain Shirt', 'Armor (Chain Shirt)'],
  ['Scale Mail', 'Armor (Scale Mail)'],
  ['Breastplate', 'Armor (Breastplate)'],
  ['Half Plate Armor', 'Armor (Half Plate Armor)'],
  ['Ring Mail', 'Armor (Ring Mail)'],
  ['Chain Mail', 'Armor (Chain Mail)'],
  ['Splint Armor', 'Armor (Splint Armor)'],
  ['Plate Armor', 'Armor (Plate Armor)'],
  ['Shield', 'Armor (Shield)'],
]

const RARITIES: [string, MagicItemRarity][] = [
  ['+1', 'Uncommon'],
  ['+2', 'Rare'],
  ['+3', 'Very Rare'],
]

export const weaponPlusItems: MagicItem[] = PLUS_WEAPONS.flatMap(weapon =>
  RARITIES.map(([bonus, rarity]) => ({
    id: `${weapon.toLowerCase().replace(/\s+/g, '-')}-${bonus.replace('+', 'plus')}`,
    name: `${weapon} ${bonus}`,
    category: 'Weapon' as MagicItemCategory,
    rarity,
    attunement: false,
    weight: getWeaponByName(weapon)?.weight ?? 0,
    description: `Weapon (${weapon}), ${rarity}. You have a ${bonus} bonus to attack and damage rolls with this magic weapon.`,
  }))
)

export const armorPlusItems: MagicItem[] = PLUS_ARMOR.flatMap(([armorName, typeLabel]) =>
  RARITIES.map(([bonus, rarity]) => ({
    id: `${armorName.toLowerCase().replace(/\s+/g, '-')}-${bonus.replace('+', 'plus')}`,
    name: `${armorName} ${bonus}`,
    category: 'Armor' as MagicItemCategory,
    rarity,
    attunement: false,
    weight: getArmorByName(armorName)?.weight ?? 0,
    description: `${typeLabel}, ${rarity}. You have a ${bonus} bonus to AC while wearing this armor.`,
  }))
)

/** Complete magic item catalogue: SRD entries + specific +1/+2/+3 weapons and armor. */
export const allMagicItems: readonly MagicItem[] = [...magicItems, ...weaponPlusItems, ...armorPlusItems]

// ─── Lookup helpers ─────────────────────────────────────────────────────────

export function getMagicItemById(id: string): MagicItem | undefined {
  return allMagicItems.find(i => i.id === id)
}

export function getMagicItemsByCategory(cat: MagicItemCategory): MagicItem[] {
  return allMagicItems.filter(i => i.category === cat)
}

export function getMagicItemsByRarity(rarity: MagicItemRarity): MagicItem[] {
  return allMagicItems.filter(i => i.rarity === rarity)
}